...
namespace SimpleHttpServer.RouteHandlers
{
    ...
    // HTTP требует, чтобы resposnes содержал правильный тип MIME. Этот список быстрого отображения ниже
    // содержит гораздо больше mimetypes, чем System.Web.MimeMapping
