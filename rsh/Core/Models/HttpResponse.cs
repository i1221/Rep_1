...
// NOTE: два следствия этой упрощенной модели ответа: (two consequences of this simplified response model are:)
//
//      (a) невозможно отправить 8-битные чистые ответы (например, содержимое файла) (it's not possible to send 8-bit clean responses (like file content))
//      (b) it's 
...
namespace SimpleHttpServer.Models
{
    ...
    {
        // Полный список кодов состояния см. (for a full list of status codes, see..)
    ...
    public class HttpResponse
    {
        ...
        // только для информации... (informational only tostring...)
